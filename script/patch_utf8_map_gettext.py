...
# Dynamic map strings are stored in map/campaign data rather than passed
# through gettext at the normal UI call sites. For UTF-8 translation builds,
# translate these strings using the active catalog so scenario names,
# descriptions, map events and rumors can use the same Unicode renderer.
