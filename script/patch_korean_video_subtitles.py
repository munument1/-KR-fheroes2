...
def encode_intro_literals(source: str) -> str:
    ...
    # Korean subtitles need a larger face and a narrower measure than the
    # stock subtitle defaults. This keeps lines short enough to read quickly
    # while preserving the existing black contour generated by Subtitle.
...
def main() -> None:
    ...
    print("Prepared Korean subtitles for INTRO.SMK, GOOD01.SMK and EVIL01.SMK with readability tuning.")
