...
void Interface::AdventureMap::EventCheatCodeCheck( fheroes2::Key key )
{
    ...
    if ( ( mode == 8675309 && key == nextExpectedKey ) || key == fheroes2::Key::KEY_8 ) {
        ...
        case fheroes2::Key::KEY_8:
            nextExpectedKey = fheroes2::Key::KEY_6;
            break;
        case fheroes2::Key::KEY_6:
            nextExpectedKey = fheroes2::Key::KEY_7;
            break;
        case fheroes2::Key::KEY_7:
            nextExpectedKey = fheroes2::Key::KEY_5;
            break;
        case fheroes2::Key::KEY_5:
            nextExpectedKey = fheroes2::Key::KEY_3;
            break;
        case fheroes2::Key::KEY_3:
            nextExpectedKey = fheroes2::Key::KEY_0;
            break;
        case fheroes2::Key::KEY_0:
            nextExpectedKey = fheroes2::Key::KEY_9;
            break;
        ...
        switch ( key ) {
        case fheroes2::Key::KEY_3:
            nextExpectedKey = fheroes2::Key::KEY_2;
            break;
        case fheroes2::Key::KEY_2:
            nextExpectedKey = fheroes2::Key::KEY_1;
            break;
